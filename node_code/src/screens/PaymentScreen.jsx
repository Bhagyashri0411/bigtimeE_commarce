...
const PaymentScreen = ({history}) => {
    ...
    return (
        <>
            <Header />
            <div className="container d-flex justify-content-center align-items-center login-info mt-5 border rounded p-5">
                <form action="" className="Login2 col-md-8 col-lg-4 col-11" onSubmit={submitHandler}>
                    ...
                    <button type="submit" className="btn tophead blue w-100 rounded-0">
                        Continue
                    </button>
                </form>
            </div>
